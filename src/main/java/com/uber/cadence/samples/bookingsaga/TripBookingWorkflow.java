...
public interface TripBookingWorkflow {
  ...
  void bookTrip(ReserveCarCommand reserveCarCommand, Hotelservice.ReserveHotelCommand reserveHotelCommand,
                Flightservice.ReserveFlightCommand reserveFlightCommand);
}
